    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text(workoutModel?.message ?? "Welcome to your Workout Schedule")
                    .font(.title)
                    .fontWeight(.bold)
...
#Preview {
    WorkoutDetailView(workoutModel: WorkoutModel(message: "Your Weekly Fitness Plan", workoutSchedule: [
